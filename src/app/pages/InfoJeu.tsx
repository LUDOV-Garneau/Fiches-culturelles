...
function getLocalGame(id?: string): Game {
  ...
  return (
    LOCAL_DB[id] ?? {
      ...
      developer: "—",
      description:
        "Lorem ipsum dolor sit amet,Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vitae.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vitae. consectetur adipiscing elit. Integer vitae.",
      genres: ["Indie"],
      cover: null,
      developerLogo: null,
    }
...
export default function InfoJeu({ id: idProp }: { id?: string }) {
  ...
  // Ici  pour brancher API pour la bd
  // Pour l’instant, on prend la mini DB locale.
                ...
                <div className="aspect-[16/9] w-full overflow-hidden rounded-lg bg-gray-200">
                  {game.cover ? (
                    ...
                    <div className="flex h-full items-center justify-center text-xs text-gray-500">
                      {/* ICI POUR LA GROSS IMAGE DU JEUX QU'ON VOIs*/}
                      (image à venir)
                    </div>
                  )}
                </div>
